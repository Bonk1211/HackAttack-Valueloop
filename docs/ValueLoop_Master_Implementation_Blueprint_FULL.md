...
3. Support at least four cause hypotheses, including Payment and Technical/Support.
...
| FR-05 Cause hypotheses              | Rank Payment, Technical/Support, Product Fit, Price/Plan Fit, Disengagement, Lifecycle and Unknown; include evidence and contradictions.             |
...
- At least 10 accounts per major cause pattern: payment failure, technical/support, low adoption, plan mismatch and normal variance.
...
|------------------------|--------------------------------------|-----------------------|----------------------------------------|
| In-app education       | Low adoption, no severe issue        | Yes                   | Frequency cap and opt-out              |
...
| Plan review/downgrade  | Persistent under-utilization         | No                    | CSM/customer; show lower-cost option   |
